 ...
 * @method static void restore(string $archive, array $overrides = [])
 ...
 * @method static \SahilJB\LaraAutoBackup\BackupManager extendRestorer(string $driver, callable $resolver)
